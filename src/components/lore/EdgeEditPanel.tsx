...
export default function EdgeEditPanel({ edge, onUpdate, onClose }: Props) {
  ...
  return (
    <div className="absolute right-4 top-16 bottom-4 z-50 w-72 max-h-[calc(100vh-6rem)] flex flex-col bg-card/95 backdrop-blur-md border border-border rounded-xl shadow-2xl animate-in slide-in-from-right-4 duration-200 overflow-hidden">
      ...
      <div className="flex-shrink-0 p-4 pt-3 border-t border-border bg-card/95">
